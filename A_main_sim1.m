...
RLS = 10* log10(mean(mean(Err_RLS(:,2000:end))))
RMC = 10* log10(mean(mean(Err_MCC_RLS(:,2000:end))))
RMEE = 10* log10(mean(mean(Err_RLS_MEE1(:,2000:end))))
GS_RAF = 10* log10(mean(mean(Err_GS_RAF(:,2000:end))))
